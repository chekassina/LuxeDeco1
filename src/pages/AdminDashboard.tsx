      ...
      if (supabase) {
        ...
        try {
          ...
          if (uploadError) {
            ...
            alert(`Failed to upload to Supabase: ${uploadError.message}. Make sure your bucket is public and CORS is configured.`);
            continue;
          }
          ...
          console.error(error);
          alert(`Error uploading image. Is Supabase configured correctly?`);
        }
      } else {
        alert("Supabase is not configured. Please add your SUPABASE URL and KEY to .env to upload images.");
      }
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="flex space-x-4">
            <button onClick={() => setEditingProduct({ nameEn: '', nameFr: '', imageUrls: [], priceFcfa: 0, stockQuantity: 0, category: categories[0]?.id || '', specifications: [], isFeatured: true })} className="bg-gold text-black px-6 py-2 text-xs font-bold uppercase tracking-widest flex items-center space-x-2 rounded-sm hover:opacity-90">
